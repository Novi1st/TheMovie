 package com.example.user.myintentapp;
     ...
     public void onClick(View v) {
         switch (v.getId()){
             ...
             case R.id.btn_move_activity_data:
                 ...
                 moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Novi Nurkhaeni");
                 moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_AGE, 20);
                 moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_HOBBY, "Stalking mantan");
                 startActivity(moveWithDataIntent);
                 break;

             case R.id.btn_move_activity_object:
                 Person mPerson = new Person();
                 mPerson.setName("Novi Nurkhaeni");
                 mPerson.setAge(20);
                 mPerson.setEmail("novinurkhaeni.1@gmail.com");
             ...
             case R.id.btn_dial_number:
                 String phoneNumber = "0895603223774";
